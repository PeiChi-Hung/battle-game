...
class TestTask2(unittest.TestCase):
    ...
    def test_soldier(self):
        ...
        ## put init tests here
        try:
            self.assertEqual(t1.get_cost(), 1, msg = "Cost of Soldier not created correctly")
        except AssertionError as e:
            self.verificationErrors.append(str(e))

        try:
            self.assertEqual(t1.get_speed(), 1, msg = "Speed of Soldier not created correctly")
        except AssertionError as e:
            self.verificationErrors.append(str(e))

        try:
            self.assertEqual(t1.get_attack_damage(), 1, msg = "Attack damage of Soldier not created correctly")
        except AssertionError as e:
            self.verificationErrors.append(str(e))
    ...
    def test_archer(self):
        ...
        try:
            self.assertEqual(t1.get_cost(), 2, msg = "Cost of Soldier not created correctly")
        except AssertionError as e:
            self.verificationErrors.append(str(e))

        try:
            self.assertEqual(t1.get_speed(), 3, msg = "Speed of Soldier not created correctly")
        except AssertionError as e:
            self.verificationErrors.append(str(e))
    ...
    def test_cavalry(self):
        ...
        try:
            self.assertEqual(t1.get_cost(), 3, msg = "Cost of Soldier not created correctly")
        except AssertionError as e:
            self.verificationErrors.append(str(e))

        try:
            self.assertEqual(t1.get_speed(), 2, msg = "Speed of Soldier not created correctly")
        except AssertionError as e:
            self.verificationErrors.append(str(e))
