...
class TestTask5(unittest.TestCase):
    ...
    def test__conduct_combat(self):
        ...
        t1._Army__assign_army("", 1, 1, 1, formation)
        t2._Army__assign_army("", 1, 2, 3, formation)
        try:
            self.assertTrue(battle._Battle__conduct_combat(t1, t2, formation) == 2, "Gladiatorial 1,1,1 1,2,3 failed")
        except AssertionError as e:
            self.verificationErrors.append(str(e))
        
        t1._Army__assign_army("", 4, 5, 1, formation)
        t2._Army__assign_army("", 1, 1, 1, formation)
        try:
            self.assertTrue(battle._Battle__conduct_combat(t1, t2, formation) == 1, "Gladiatorial 4,5,1 1,1,1 failed")
        except AssertionError as e:
            self.verificationErrors.append(str(e))
